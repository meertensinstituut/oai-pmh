  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <p class="info">You are viewing an HTML version of the <a target="_blank" href="https://github.com/meertensinstituut/oai-pmh">generated XML OAI-PMH response</a>. To see the underlying XML as it appears to any OAI-PMH harvester use your web browser's <em>view source</em> option or disable XSLT processing.</p>        
        <xsl:call-template name="quicklinks"/>
        <xsl:apply-templates select="/oai:OAI-PMH"/>
        <xsl:call-template name="quicklinks"/>
        <p class="info">This XSL script is based on a <a target="_blank" href="https://github.com/opencultureconsulting/oai_pmh">version</a> originally written by Christopher Gutteridge at University of Southampton for the EPrints project that was later adapted by Sebastian Meyer at Open Culture Consulting to be more generally applicable to other OAI-PMH interfaces.</p>
      </body>
    </html>
  </xsl:template>
